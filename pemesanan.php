                ...
                <div class="border rounded-4 p-4" style="background-color: #28a745; color: white;">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                            <?php if (isset($kontak) && $kontak && !empty($kontak['no_wa'])): ?>
                                <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $kontak['no_wa']) ?>" 
                                   class="btn btn-light btn-lg px-4 rounded-pill text-decoration-none text-dark" 
                                   target="_blank">
                                    <i class="bi bi-whatsapp me-2"></i>Hubungi Kami
                                </a>
                            <?php else: ?>
                                <button class="btn btn-light btn-lg px-4 rounded-pill" disabled>
                                    <i class="bi bi-telephone me-2"></i>Kontak Tidak Tersedia
                                </button>
                            <?php endif; ?>
                        </div>
                    </div>
